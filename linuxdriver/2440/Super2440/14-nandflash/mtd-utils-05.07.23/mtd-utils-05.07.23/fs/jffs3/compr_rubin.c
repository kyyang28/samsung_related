 ...
 *
 * JFFS2 Id: compr_rubin.c,v 1.20 2004/06/23 16:34:40 havasi  Exp
 * $Id: compr_rubin.c,v 3.5 2005/01/05 16:18:59 dedekind Exp $
 *
 */
...
static struct jffs3_compressor jffs3_rubinmips_comp = {
    .priority = JFFS3_RUBINMIPS_PRIORITY,
    .name = "rubinmips",
    .compr = JFFS3_COMPR_DYNRUBIN,
    .compress = NULL, /*&jffs3_rubinmips_compress,*/
    .decompress = &jffs3_rubinmips_decompress,
#ifdef JFFS3_RUBINMIPS_DISABLED
    .disabled = 1,
#else
    .disabled = 0,
#endif
...
{
    return jffs3_register_compressor(&jffs3_rubinmips_comp);
}

void jffs3_rubinmips_exit(void)
{
    jffs3_unregister_compressor(&jffs3_rubinmips_comp);
}

static struct jffs3_compressor jffs3_dynrubin_comp = {
    .priority = JFFS3_DYNRUBIN_PRIORITY,
    .name = "dynrubin",
    .compr = JFFS3_COMPR_RUBINMIPS,
    .compress = jffs3_dynrubin_compress,
    .decompress = &jffs3_dynrubin_decompress,
#ifdef JFFS3_DYNRUBIN_DISABLED
    .disabled = 1,
#else
    .disabled = 0,
#endif
...
{
    return jffs3_register_compressor(&jffs3_dynrubin_comp);
}

void jffs3_dynrubin_exit(void)
{
    jffs3_unregister_compressor(&jffs3_dynrubin_comp);
}
