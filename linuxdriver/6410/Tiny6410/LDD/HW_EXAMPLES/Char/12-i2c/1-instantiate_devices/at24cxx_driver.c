...
{
    /* 
     *  Reach here means the device address is present,
     *  however, some devices can not be distinguished based on
     *  address only. (e.g. A device and B device have the same address(such as 0x50))
     *  So, we need to get further infomation by R/W the I2C device.
     */
