...
static void nand_read_ll(unsigned int nand_addr, unsigned char *sdram_addr, unsigned int len)
{
	int index = 0;
...
void copy2sdram(unsigned int nand_addr, unsigned char *sdram_addr, unsigned int len)
{
